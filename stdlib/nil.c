...
void init_nil(VM *vm)
{
    VALUE klass = defineNativeClass(vm, "Nil", NULL, NULL, "Iterable", CLS_NIL, 0, true);
    ...
    nil_iterator_class = defineNativeClass(vm, "NilIterator", NULL, NULL, "Iterator", CLS_ITERATOR, 0, true);
