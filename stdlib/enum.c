...
{
    enum_class = defineNativeClass(vm, "Enum", &enum_constructor, &enum_destructor, "Iterable", CLS_ENUM, true);
    ...
    enum_value_class = defineNativeClass(vm, "EnumValue", &enumvalue_constructor, &enumvalue_destructor, "Number", CLS_ENUM_VALUE, false);
    ...
    enum_iterator_class = defineNativeClass(
        vm, "EnumIterator", &enum_iterator_constructor, &enum_iterator_destructor, "Iterator", CLS_ITERATOR, false);
