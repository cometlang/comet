...
typedef enum {
  ...
  TOKEN_COLON, TOKEN_EOL, TOKEN_VBAR,
  ...
  // Keywords.
  TOKEN_CLASS, TOKEN_ELSE, TOKEN_ENUM, TOKEN_FALSE,
  TOKEN_FOR, TOKEN_FUN, TOKEN_IF, TOKEN_IN, TOKEN_INSTANCEOF,
  TOKEN_NIL, TOKEN_OPERATOR, TOKEN_RETURN,
